...
\begin{Verbatim}
请参见\ref{sec:introduction,sec:conclusion}。
请参见\ref{sec:introduction,sec:math,sec:reference,sec:float}。
请参见\ref{sec:introduction,sec:math,sec:reference,,sec:float}。
请参见\ref{sec:introduction,sec:reference,sec:conclusion}。
请参见\ref{sec:introduction,sec:reference,sec:conclusion,%
...
\begin{itemize}
  \item 请参见\ref{sec:introduction,sec:conclusion}。
  \item 请参见\ref{sec:introduction,sec:math,sec:reference,sec:float}。
  \item 请参见\ref{sec:introduction,sec:math,sec:reference,,sec:float}。
  \item 请参见\ref{sec:introduction,sec:reference,sec:conclusion}。
  \item 请参见\ref{sec:introduction,sec:reference,sec:conclusion,%
        algo:algorithm,fig:parallel1,lst:fibonacci}。
\end{itemize}
