## TongjiThesis LaTeX Class vVERSION_TOKEN
...
- `TongjiThesis-vVERSION_TOKEN-science.pdf` — 理工科 (science/engineering)
- `TongjiThesis-vVERSION_TOKEN-humanities.pdf` — 文科 (humanities)

#### CTAN 包 | CTAN Package (LaTeX 包管理器分发 | for package distribution)

- `tongjithesis-ctan-vVERSION_TOKEN.tar.gz`
- `tongjithesis-ctan-vVERSION_TOKEN.zip`
